...
if __name__ == "__main__":
    ...
    # E = 9
    # g = defaultdict(dict)
    print("|V| = %.2d, |E| = %.2d, s = %.d, t = %.d" % (V, E, source, sink))
    insert_edges_from_iterable(g, edges)
    t1 = perf_counter()
    maxflow1 = fifo_push_relabel(g, source, sink)
    t1 = perf_counter() - t1
    ...
    insert_edges_from_iterable(g, edges)
    t2 = perf_counter()
    maxflow2 = relabel_to_front(g, source, sink)
    t2 = perf_counter() - t2
